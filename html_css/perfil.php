...
<body class="bg-light min-vh-100 d-flex align-items-center justify-content-center">
    <div class="card shadow px-3 py-4" style="max-width: 450px; width: 100%;">
        <div class="text-center mb-4">
            <div class="rounded-circle bg-dark bg-opacity-25 d-flex align-items-center justify-content-center mx-auto mb-2" style="width: 100px; height: 100px; font-size: 4rem;">
        ...
        <div class="mb-4 ps-2" style="margin-left:auto; margin-right:auto; max-width: 95%; text-align: left;">
            ...
            <p class="mb-2"><span class="fw-semibold text-secondary">Celular:</span> <?php echo htmlspecialchars($usuario['telefonecelular']); ?></p>
